                ...
                <div>
                    <Form style={{ marginTop: 30 }} className="form" >
                        <Form.Group controlId="formBasicEmail">
                            <Form.Label style={{display:'flex',justifyContent:'center'}}>Email address</Form.Label>
                            <Form.Control className="col-md-12 col-xs-12" type="email" placeholder="Enter email" onChange={(e) => setEmail(e.target.value)} />
                        ...
                        <Form.Group controlId="formBasicPassword">
                            ...
                            <Form.Control type="password" className="col-md-12 col-xs-12" placeholder="Password" onChange={(e) => setPassword(e.target.value)} />
                        </Form.Group>
